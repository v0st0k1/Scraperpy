"""
Scrapea nombres de empresas para cnae 2412 de iberinform.es
Escribe el resultado en archivo cnae2412.csv
...
def construye_url(pagina):
    ...
    return "https://www.iberinform.es/es/productos/directorio-empresas/"\
        "directorio-cnae/4212/construccion-de-vias-ferreas-de-superficie-y"\
        "-subterraneas/paginacion/"+str(pagina)
