"""
Scrapea nombres de empresas para cnae 2411 de iberinform.es
Escribe el resultado en archivo cnae2411.csv
...
def construye_url(pagina):
    ...
    return "https://www.iberinform.es/es/productos/directorio-empresas/"\
        "directorio-cnae/4211/construccion-de-carreteras-y-autopistas/"\
