...
def construye_url(pagina):
    ...
    return "https://www.iberinform.es/es/productos/directorio-empresas/"\
        "directorio-cnae/9499/otras-actividades-asociativas--no-comprendido"\
        "---clasificado-en-otra-parte-/paginacion/"+str(pagina)
...
#Escribe en .csv
name_csv = 'cnae9499.csv'
with open(name_csv, 'w', encoding='utf-8') as myfile:
    wr = csv.writer(myfile, quoting=csv.QUOTE_ALL) #Entrecomillar para despue
